...
if page == "Note":
    ...
    # Fetch latitudes and longitudes from MongoDB
    latitudes = []
    longitudes = []
    for doc in collection.find({}, {"_id": 0, "latitude": 1, "longitude": 1}):
        if "latitude" in doc and "longitude" in doc:
            latitudes.append(doc["latitude"])
            longitudes.append(doc["longitude"])
    ...
    st.write("Latitudes and Longitudes on Map:")
    st.write(m)
